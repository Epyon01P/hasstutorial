...
In general, I would tend to go with the 64-bit OS, unless you have a Pi 3, in which case you must use the 32-bit OS as the Pi 3 doesn’t have 64-bit capabilities.
